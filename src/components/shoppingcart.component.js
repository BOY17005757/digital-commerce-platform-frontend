...
export default class ShoppingCart extends Component {
  ...
  //get users shopping cart products
  getShoppingCartProducts() {
    ...
    ShoppingCartService.getShoppingCartProducts(self.state.currentUser.id)
  ...
  decreaseQuantity(productId, quantity) {
    ...
    if (quantity === 1) {
      ...
      ShoppingCartService.decrementShoppingCartProduct(self.state.currentUser.id, productId, 1)
        .then(function (product) {

          //call shopping cart products function
          self.getShoppingCartProducts();
  ...
  removeProduct(productId) {
    ...
    ShoppingCartService.removeShoppingCartProduct(self.state.currentUser.id, productId)
      .then(function (product) {
  ...
  //disable checkout button if user has no products in shopping cart
  ...
  //generate shopping cart products html
  ...
  //generate collection time slot dropdown
  getCollectionHtml() {
  ...
  //display order successful modal
  toggleOrderSuccess() {
  ...
  //generate order successful modal
  orderSuccessModal() {
