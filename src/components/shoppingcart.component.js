  ...
  render() {
    ...
    return (
        <div>
            ...
            <div class="flex flex-col w-full p-8 text-gray-800 bg-white shadow-lg pin-r pin-y md:w-4/5 lg:w-4/5 lg:shadow-lg lg:rounded-lg py-8">
                <div class="flex-1">
                ...
                <div class="my-4 mt-6 -mx-2 lg:flex">
                    ...
                    <div class="p-4">
                        ...
                        <textarea class="w-full h-24 p-2 bg-gray-800 focus:ring-2 focus:ring-indigo-200 text-white rounded" placeholder="If you have some information for the seller, please enter it here."></textarea>
                    </div>
                    </div>
                    <div class="lg:px-2 lg:w-1/2">
                    ...
                    <div class="p-4">
                        ...
                        <a href="#">
                            <button class="flex justify-center w-full px-10 py-3 mt-6 font-medium text-white uppercase bg-indigo-600 rounded-full shadow item-center hover:bg-gray-700 focus:shadow-outline focus:outline-none ">
